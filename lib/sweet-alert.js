...
(function() {
  ...
  var getModal = function() {
    ...
    escapeHtml = function(str) {
      ...
      // checking if it's an array and loop putting the line + break line
      if(Array.isArray(str)) {
          str.forEach(function(strLine) {
              div.appendChild(document.createTextNode(strLine));
...
// These polyfills can be removed if it's targeting newer plataforms

// Adding a polyfill for Array.isArray
