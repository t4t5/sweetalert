...
(function() {
  ...
  window.sweetAlert = function() {
    ...
    var onButtonClick = function(e) {
      var target = e.target || e.srcElement,
          ...
          modalIsVisible     = modal.classList.contains('visible'),
    ...
    if (params.type) {
      ...
      switch (params.type) {
        case "success":
          ...
          $icon.querySelector('.tip').classList.add('animateSuccessTip');
          $icon.querySelector('.long').classList.add('animateSuccessLong');
          break;
        case "error":
          $icon.classList.add('animateErrorIcon');
          $icon.querySelector('.x-mark').classList.add('animateXMark');
          break;
        case "warning":
          $icon.classList.add('pulseWarning');
          $icon.querySelector('.body').classList.add('pulseWarningIns');
          $icon.querySelector('.dot').classList.add('pulseWarningIns');
          break;
      }
  ...
  function openModal() {
    ...
    show(modal);
    modal.classList.add('showSweetAlert');
    modal.classList.remove('hideSweetAlert');
  ...
  function closeModal() {
    ...
    fadeOut(modal, 5);
    modal.classList.remove('showSweetAlert');
    modal.classList.add('hideSweetAlert');
    ...
    $successIcon.querySelector('.tip').classList.remove('animateSuccessTip');
    $successIcon.querySelector('.long').classList.remove('animateSuccessLong');

    var $errorIcon = modal.querySelector('.icon.error');
    $errorIcon.classList.remove('animateErrorIcon');
    $errorIcon.querySelector('.x-mark').classList.remove('animateXMark');

    var $warningIcon = modal.querySelector('.icon.warning');
    $warningIcon.classList.remove('pulseWarning');
    $warningIcon.querySelector('.body').classList.remove('pulseWarningIns');
    $warningIcon.querySelector('.dot').classList.remove('pulseWarningIns');
  }
