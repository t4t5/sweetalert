...
;(function(window, document, undefined) {
  ...
  function modalDependant() {
    ...
    var onButtonEvent = function(event) {
      ...
      var target = e.target || e.srcElement,
          ...
          targetedColor      = params.confirmButtonColor; // Confirm as default (just a choice)

      if (targetedCancel) {
        targetedColor = params.cancelButtonColor;
      }

      switch (e.type) {
        case ("mouseover"):
          if (targetedConfirm || targetedCancel) {
            target.style.backgroundColor = colorLuminance(targetedColor, -0.04);
          }
          break;
        case ("mouseout"):
          if (targetedConfirm || targetedCancel) {
            target.style.backgroundColor = targetedColor;
          }
          break;
        case ("mousedown"):
          if (targetedConfirm || targetedCancel) {
            target.style.backgroundColor = colorLuminance(targetedColor, -0.14);
          }
          break;
        case ("mouseup"):
          if (targetedConfirm || targetedCancel) {
  ...
  function setParameters(params) {
    ...
    // Set confirm's and cancel's button to selected background color
