...
(function(window, document) {
  ...
  function setParameters(params) {
    ...
    modal.setAttribute('data-done-function', params.doneFunction);
  ...
  function openModal() {
    ...
    if (timer !== "null") {
      setTimeout(function() {
        if (modal.getAttribute('data-has-done-function') === 'true')
        {
          doneFunction = null;
          eval( "doneFunction = " +  modal.getAttribute('data-done-function'));
          doneFunction(null);
        }
        closeModal();
      }, timer);
