...
(function(window, document) {
  ...
  window.sweetAlert = window.swal = function() {
	...
	if(hasClass(getModal(), 'visible'))
		addClass(getModal(), 'do_not_kill');
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.timeout 			  = arguments[0].timeout || params.timeout;
        params.doneFunction       = arguments[1] || null;
        params.noButton		      = (params.timeout || params.allowOutsideClick) && (arguments[0].noButton || params.noButton) ;
	...
	if(params.timeout != null){
		setTimeout(closeModal, 1000 * params.timeout);
	}
