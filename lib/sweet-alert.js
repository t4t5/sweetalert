...
;(function(window, document, undefined) {
  ...
  sweetAlert = swal = function() {
    ...
    var clickResponder = function(event) {
      var e = event || window.event;
      var target = e.target || e.srcElement;
      var clickedOnModal = (modal === target),
          clickedOnModalChild = isDescendant(modal, target),
          modalIsVisible = hasClass(modal, 'visible'),
          outsideClickIsAllowed = modal.getAttribute('data-allow-outside-click') === 'true';
    ...
    document.onclick = clickResponder;
    document.getElementsByClassName('sweet-overlay')[0].onclick = clickResponder;
