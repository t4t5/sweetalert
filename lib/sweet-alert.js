...
(function() {
  ...
  var getModal = function() {
    ...
    getTopMargin = function(element) {
      ...
      var padding = parseInt(getComputedStyle(element).getPropertyValue('padding'), 10);
  ...
  function closeModal() {
    ...
    var $success = modal.querySelector('.icon.success');
    removeClass($success, 'animate');
    removeClass($success.querySelector('.tip'), 'animateSuccessTip');
    removeClass($success.querySelector('.long'), 'animateSuccessLong');

    var $error = modal.querySelector('.icon.error');
    removeClass($error, 'animateErrorIcon');
    removeClass($error.querySelector('.x-mark'), 'animateXMark');

    var $warning = modal.querySelector('.icon.warning');
    removeClass($warning, 'pulseWarning');
    removeClass($warning.querySelector('.body'), 'pulseWarningIns');
    removeClass($warning.querySelector('.dot'), 'pulseWarningIns');
  }
